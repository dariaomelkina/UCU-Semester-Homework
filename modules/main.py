...
app.layout = html.Div(
    [html.H1(children='MARTIAN WEATHER PROJECT', style={
     ...
     dcc.Tabs(id='tabs-example', value='tab-1', children=[
         dcc.Tab(label='{}'.format(week_weather.days_list()[0]), value='tab-1', style={'color': 'DarkOrange'}, selected_style={
             'backgroundColor': 'OldLace',
             'color': 'grey',
         }),
         dcc.Tab(label='{}'.format(week_weather.days_list()[1]), value='tab-2', style={'color': 'DarkOrange'}, selected_style={
             'backgroundColor': 'OldLace',
             'color': 'grey',
         }),
         dcc.Tab(label='{}'.format(week_weather.days_list()[2]), value='tab-3', style={'color': 'DarkOrange'}, selected_style={
             'backgroundColor': 'OldLace',
             'color': 'grey',
         }),
         dcc.Tab(label='{}'.format(week_weather.days_list()[3]), value='tab-4', style={'color': 'DarkOrange'}, selected_style={
             'backgroundColor': 'OldLace',
             'color': 'grey',
         }),
         dcc.Tab(label='{}'.format(week_weather.days_list()[4]), value='tab-5', style={'color': 'DarkOrange'}, selected_style={
             'backgroundColor': 'OldLace',
             'color': 'grey',
         }),
         dcc.Tab(label='{}'.format(week_weather.days_list()[5]), value='tab-6', style={'color': 'DarkOrange'}, selected_style={
             'backgroundColor': 'OldLace',
             'color': 'grey',
         }),
         dcc.Tab(label='{}'.format(week_weather.days_list()[6]), value='tab-7', style={'color': 'DarkOrange'}, selected_style={
             'backgroundColor': 'OldLace',
             'color': 'grey',
         }),
